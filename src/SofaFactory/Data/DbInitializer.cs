...
namespace SofaFactory.Data
{
    public class DbInitializer
    {
        public static void Initialize(StoreContext context)
        {
            ...
            {
                context.Sofas.Add(sofa);
            }

            foreach (var sample in samples)
            {
                context.Sofas.Add(sample);
            }
